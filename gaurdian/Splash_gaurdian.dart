...
import 'package:doctors_app/gaurdian/Health_report_gaurdian.dart';
import 'package:doctors_app/gaurdian/appointment_list_gaurdian.dart';
import 'package:doctors_app/gaurdian/doctor_list_gaurdian.dart';
import 'package:doctors_app/gaurdian/gaurdian_list_gaurdian.dart';
import 'package:doctors_app/gaurdian/health_parameter_gaurdian.dart';
import 'package:doctors_app/gaurdian/live_location_gaurdian.dart';
import 'package:doctors_app/gaurdian/medicine_list_gaurdian.dart';
//import 'package:doctors_app/gaurdian/patient_record_gaurdian.dart';
import 'package:doctors_app/gaurdian/safe_loaction_gaurdian.dart';
...
class Splash extends StatefulWidget {
  final Map<String, dynamic> gaurdianData; // Receiving patient data
  final List<String> patientIds;
  const Splash(
      {super.key, required this.gaurdianData, required this.patientIds});
...
class _SplashState extends State<Splash> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    String gaurdianName =
        widget.gaurdianData['name'] ?? 'Patient'; // Fetch patient name
    int gaurdianAge = widget.gaurdianData['age'] ?? 0;
    String gaurdianPhone = widget.gaurdianData['phone'] ?? 'N/A';
      ...
      appBar: AppBar(
        leading: IconButton(
          onPressed: () async {
            ...
            if (currentUser != null &&
                currentUser.uid == widget.gaurdianData['uid']) {
        ...
        title: Text('Welcome, ${widget.gaurdianData['name'] ?? 'Doctor'}'),
                      ...
                      builder: (context) {
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("Name: $gaurdianName",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold)),
                              SizedBox(height: 10),
                              Text("Age: $gaurdianAge",
                                  style: TextStyle(fontSize: 18)),
                              SizedBox(height: 10),
                              Text("Phone: $gaurdianPhone",
                                  style: TextStyle(fontSize: 18)),
                            ],
                          ),
                        );
