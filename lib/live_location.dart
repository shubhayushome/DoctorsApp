...
class _LiveLocationListScreenState extends State<LiveLocationListScreen> {
  ...
  List<Map<String, String>> safeLocations = [
    {
      ...
      'latitude': '22.653962',
      'longitude': '88.44513',
      'image': 'https://i.ytimg.com/vi/ZkeDIPJcV38/maxresdefault.jpg',
    },
    {
  ...
  final String startLatitude = '22.586656';
  final String startLongitude = '88.304115';

  void _openDirections(String destinationLatitude, String destinationLongitude,
      String location_name) async {
    double? startlat = double.tryParse(startLatitude);
    double? startlng = double.tryParse(startLongitude);
    double? destlat = double.tryParse(destinationLatitude);
    double? destlng = double.tryParse(destinationLongitude);
  ...
  void _openGoogleMaps(BuildContext context) async {
    ...
    double? lat = double.tryParse(startLatitude);
    double? lng = double.tryParse(startLongitude);
