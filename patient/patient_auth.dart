...
import 'package:doctors_app/patient/Splash_patient.dart';
    ...
    try {
      ...
      if (!_isLogin) {
        ...
        if (userId != null) {
          ...
          await _fire.addPatientDataFirestore(
              userId, name, email, password, gender, age, phone);

          Map<String, dynamic>? patientData =
              await _fire.getPatientData(userId);
          if (patientData == null) {
          ...
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (ctx) =>
                  Splash(patientData: patientData, userId: userId),
            ),
          );
        }
      } else {
        ...
        Map<String, dynamic>? patientData =
            await _fire.getPatientData(user.uid);
        if (patientData == null) {
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (ctx) =>
                Splash(patientData: patientData, userId: user.uid),
          ),
        );
      }
